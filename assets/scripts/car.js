...
function startCar5(){
	...
	let tl = gsap.timeline({ease:Linear.none, onComplete:continueCar5 });
	...
	// tl.to('#carsvg', 0.4, { rotation:560, y:'+=4', x:'+=10'},'-=0.2')
	// tl.to('#carsvg', 0.4, { rotation:550, y:'+=4', x:'+=10'},'-=0.2')
	// tl.to('#carsvg', 0.4, { rotation:550, y:'+=4', x:'+=10'},'-=0.2')
	// tl.to('#carsvg', 0.4, { rotation:550, y:'+=4', x:'+=10'},'-=0.2')
	// tl.to('#carsvg', 0.4, { rotation:550, y:'+=4', x:'+=10'},'-=0.2')

	// tl.timeScale(4); // speed animation up
